...
post = Post.create(user_id: u.id)
post2 = Post.create(user_id: u.id)
...
post3 = Post.create(user_id: u.id)
post4 = Post.create(user_id: u.id)
...
post5 = Post.create(user_id: u.id)
post6 = Post.create(user_id: u.id)
...
post7 = Post.create(user_id: u.id)
post8 = Post.create(user_id: u.id)
